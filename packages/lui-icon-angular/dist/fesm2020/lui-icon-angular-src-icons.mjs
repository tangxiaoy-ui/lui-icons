...
import { InjectionToken, Injectable, ElementRef, Renderer2, ChangeDetectorRef, Component, Inject, Input as Input$1, Optional, NgModule } from '@angular/core';
...
const AnnotateCc = [
    [
        'path',
        {
            'fill-rule': 'evenodd',
            'clip-rule': 'evenodd',
            d: 'M1.67944 7.99649L5.02302 2.78126C5.36472 2.24828 6.0791 2.08986 6.61863 2.42741C6.76304 2.51776 6.88538 2.63861 6.97683 2.78126L10.3204 7.99649C10.6621 8.52947 10.5017 9.23518 9.96221 9.57274C9.77713 9.68853 9.56257 9.75 9.3435 9.75H2.65635C2.01772 9.75 1.5 9.23857 1.5 8.60769C1.5 8.39128 1.56223 8.17932 1.67944 7.99649ZM5.99993 3.39246L2.65635 8.60769H9.3435L5.99993 3.39246Z',
            fill: '#666666',
            key: 'h69ize',
        },
    ],
...
const ArrowDoubleLeft = [
    [
        'path',
        {
            d: 'M5.87688 2.3291L2.95305 5.6709C2.80872 5.83585 2.79012 6.07214 2.89836 6.25488L2.95305 6.3291L5.87688 9.6709L5.12395 10.3291L2.20012 6.9873C1.73848 6.45952 1.70724 5.68905 2.10735 5.12891L2.20012 5.0127L5.12395 1.6709L5.87688 2.3291ZM9.87688 2.3291L6.95305 5.6709C6.80872 5.83585 6.79012 6.07214 6.89836 6.25488L6.95305 6.3291L9.87688 9.6709L9.12395 10.3291L6.20012 6.9873C5.73848 6.45952 5.70724 5.68905 6.10735 5.12891L6.20012 5.0127L9.12395 1.6709L9.87688 2.3291Z',
            fill: '#666666',
            key: '13eqg5',
        },
    ],
...
const Change = [
    [
        'path',
        {
            d: 'M1.30178 11C1.13602 11 0.977045 10.9342 0.859835 10.8169C0.615757 10.5729 0.615757 10.1771 0.859835 9.93306L3.93306 6.85984C4.05027 6.74262 4.20924 6.67678 4.375 6.67678C4.72018 6.67678 5 6.9566 5 7.30178V9.5H4V8.208L2.207 10H8.5C9.2797 10 9.92045 9.40511 9.99313 8.64446L10 8.5H11C11 9.88071 9.88071 11 8.5 11H1.30178Z',
            fill: '#666666',
            key: 'aei5qq',
        },
    ],
    [
        'path',
        {
            d: 'M10.6982 1C10.864 1 11.023 1.06585 11.1402 1.18306C11.3842 1.42714 11.3842 1.82286 11.1402 2.06694L8.06694 5.14016C7.94973 5.25738 7.79076 5.32322 7.625 5.32322C7.27982 5.32322 7 5.0434 7 4.69822V2.5H8V3.792L9.793 2H3.5C2.7203 2 2.07955 2.59489 2.00687 3.35554L2 3.5H1C1 2.11929 2.11929 1 3.5 1H10.6982Z',
            fill: '#666666',
            key: 'bkc1wx',
        },
    ],
...
const Collection = [
    [
        'path',
        {
            'fill-rule': 'evenodd',
            'clip-rule': 'evenodd',
            d: 'M3.75299 3.22499L5.4787 0.802353C5.71893 0.46492 6.18722 0.386124 6.52465 0.626357C6.59271 0.674811 6.65219 0.734295 6.70065 0.802353L8.42599 3.22599L11.3566 4.04206C11.7224 4.14388 11.9491 4.49985 11.8987 4.86584L11.878 4.96572C11.8505 5.06471 11.8029 5.15698 11.7382 5.23681L9.88299 7.52599L9.97693 10.428C9.98916 10.8075 9.71725 11.1302 9.35297 11.1916L9.25147 11.2017C9.16051 11.2047 9.06977 11.191 8.9837 11.1615L6.08899 10.167L3.19564 11.1615C2.83654 11.2848 2.44811 11.1199 2.28223 10.7898L2.24269 10.6957C2.21313 10.6097 2.19948 10.5189 2.20241 10.428L2.29499 7.52399L0.441151 5.23681C0.204063 4.94426 0.223382 4.52734 0.47063 4.25801L0.551613 4.18191C0.631442 4.11722 0.723713 4.06962 0.822701 4.04206L3.75299 3.22499ZM6.08899 1.66799L4.3622 4.09481L1.45799 4.90299L3.30738 7.18526L3.21299 10.097L6.08967 9.11016L8.96499 10.097L8.87196 7.18526L10.721 4.90299L7.81714 4.09481L6.08899 1.66799Z',
            fill: '#666666',
            key: '1jpcoo',
        },
    ],
...
const Copy = [
    [
        'path',
        {
            d: 'M7.5 3C8.32843 3 9 3.67157 9 4.5V10.5C9 11.3284 8.32843 12 7.5 12H1.5C0.671573 12 0 11.3284 0 10.5V4.5C0 3.67157 0.671573 3 1.5 3H7.5ZM1.5 4C1.22386 4 1 4.22386 1 4.5V10.5C1 10.7761 1.22386 11 1.5 11H7.5C7.77614 11 8 10.7761 8 10.5V4.5C8 4.22386 7.77614 4 7.5 4H1.5ZM10.5 0C11.2797 0 11.9204 0.594849 11.9932 1.35547L12 1.5V7.5C12 8.27967 11.4052 8.92045 10.6445 8.99316L10.5 9H10V8H10.5C10.7455 8 10.9499 7.82309 10.9922 7.58984L11 7.5V1.5C11 1.25454 10.8231 1.05015 10.5898 1.00781L10.5 1H4.5C4.25454 1 4.05015 1.17691 4.00781 1.41016L4 1.5V2H3V1.5C3 0.720327 3.59485 0.0795522 4.35547 0.00683594L4.5 0H10.5Z',
            fill: '#666666',
            key: '1517rf',
        },
    ],
...
const Checkin = [
    [
        'path',
        {
            d: 'M4 1H8V0H9V1H10.5C11.3284 1 12 1.67157 12 2.5V10.5C12 11.3284 11.3284 12 10.5 12H1.5C0.671573 12 0 11.3284 0 10.5V2.5C0 1.67157 0.671573 1 1.5 1H3V0H4V1ZM1.5 2C1.22386 2 1 2.22386 1 2.5V10.5C1 10.7761 1.22386 11 1.5 11H10.5C10.7761 11 11 10.7761 11 10.5V2.5C11 2.22386 10.7761 2 10.5 2H9V3H8V2H4V3H3V2H1.5ZM9.35352 5.35352L5 9.70703L2.64648 7.35352L3.35352 6.64648L5 8.29297L8.64648 4.64648L9.35352 5.35352Z',
            fill: '#666666',
            key: 'ocxuu9',
        },
    ],
...
const DataImport = [
    [
        'path',
        {
            d: 'M6.28906 0.000976562C6.38415 0.00193774 6.47845 0.00393061 6.57129 0.00585938L7.11426 0.0234375C9.49634 0.128552 11 0.594109 11 1.5V4.5C11 5.40589 9.49634 5.87145 7.11426 5.97656L6.57129 5.99414L6 6L5.42871 5.99414L4.88574 5.97656C3.66466 5.92268 2.67515 5.7717 2 5.51758V7.5C2 7.43698 1.99752 7.42152 2.03223 7.43848L2.06543 7.45703C2.22281 7.54837 2.48324 7.63989 2.82715 7.71973C3.5265 7.88202 4.50336 7.98047 5.65039 7.99707L6 8V9L5.42871 8.99414L4.88574 8.97656C3.66466 8.92268 2.67515 8.7717 2 8.51758V10.4609C2.00094 10.4311 2.00632 10.4258 2.03223 10.4385L2.06543 10.457C2.22281 10.5484 2.48324 10.6399 2.82715 10.7197C3.5265 10.882 4.50336 10.9805 5.65039 10.9971L6 11V12L5.42871 11.9941L4.88574 11.9766C2.59189 11.8753 1.11227 11.4397 1.00586 10.5986L1 10.5V1.5C1 0.594109 2.50366 0.128552 4.88574 0.0234375L5.42871 0.00585938C5.61455 0.00199854 5.80528 0 6 0L6.28906 0.000976562ZM11.8535 7.85352L8.70703 11H11V12H7.625C7.31135 12 7.05165 11.769 7.00684 11.4678L7 11.375V8H8V10.293L11.1465 7.14648L11.8535 7.85352ZM10 2.51758C9.32478 2.77167 8.33539 2.92268 7.11426 2.97656L6.57129 2.99414L6 3L5.42871 2.99414L4.88574 2.97656C3.66461 2.92268 2.67522 2.77167 2 2.51758V4.5C2 4.43698 1.99752 4.42152 2.03223 4.43848L2.06543 4.45703C2.22281 4.54837 2.48324 4.63989 2.82715 4.71973C3.59654 4.89827 4.70171 5 6 5C7.29829 5 8.40346 4.89827 9.17285 4.71973C9.45915 4.65327 9.68747 4.57885 9.84668 4.50293L9.93457 4.45703C9.99005 4.42484 9.99874 4.42113 10 4.46094V2.51758ZM6 1C4.70171 1 3.59654 1.10173 2.82715 1.28027C2.59794 1.33348 2.40597 1.39193 2.25684 1.45215L2.14746 1.49902C2.28072 1.56321 2.45214 1.6231 2.66211 1.67871L2.82715 1.71973C3.59654 1.89827 4.70171 2 6 2C7.29829 2 8.40346 1.89827 9.17285 1.71973C9.40206 1.66652 9.59403 1.60807 9.74316 1.54785L9.85156 1.49902C9.7193 1.43682 9.54788 1.3769 9.33789 1.32129L9.17285 1.28027C8.40346 1.10173 7.29829 1 6 1Z',
            fill: '#666666',
            key: '1jvwka',
        },
    ],
...
const DataPermission = [
    [
        'path',
        {
            d: 'M6.28906 0.000976562C6.38415 0.00193774 6.47845 0.00393061 6.57129 0.00585938L7.11426 0.0234375C9.49634 0.128552 11 0.594109 11 1.5V4.5C11 5.40589 9.49634 5.87145 7.11426 5.97656L6.57129 5.99414L6 6L5.42871 5.99414L4.88574 5.97656C3.66466 5.92268 2.67515 5.7717 2 5.51758V7.5C2 7.43698 1.99752 7.42152 2.03223 7.43848L2.06543 7.45703C2.22281 7.54837 2.48324 7.63989 2.82715 7.71973C3.5265 7.88202 4.50336 7.98047 5.65039 7.99707L6 8V9L5.42871 8.99414L4.88574 8.97656C3.66466 8.92268 2.67515 8.7717 2 8.51758V10.4609C2.00094 10.4311 2.00632 10.4258 2.03223 10.4385L2.06543 10.457C2.22281 10.5484 2.48324 10.6399 2.82715 10.7197C3.5265 10.882 4.50336 10.9805 5.65039 10.9971L6 11V12L5.42871 11.9941L4.88574 11.9766C2.59189 11.8753 1.11227 11.4397 1.00586 10.5986L1 10.5V1.5C1 0.594109 2.50366 0.128552 4.88574 0.0234375L5.42871 0.00585938C5.61455 0.00199854 5.80528 0 6 0L6.28906 0.000976562ZM9.5 6C10.5543 6 11.4177 6.81581 11.4941 7.85059L11.5 8V8.04492C11.7909 8.14808 12 8.42371 12 8.75V11.25C12 11.6642 11.6642 12 11.25 12H7.75C7.33579 12 7 11.6642 7 11.25V8
.99414L6 3L5.42871 2.99414L4.88574 2.97656C3.66461 2.92268 2.67522 2.77167 2 2.51758V4.5C2 4.43698 1.99752 4.42152 2.03223 4.43848L2.06543 4.45703C2.22281 4.54837 2.48324 4.63989 2.82715 4.71973C3.59654 4.89827 4.70171 5 6 5C7.29829 5 8.40346 4.89827 9.17285 4.71973C9.45915 4.65327 9.68747 4.57885 9.84668 4.50293L9.93457 4.45703C9.99005 4.42484 9.99874 4.42113 10 4.46094V2.51758ZM6 1C4.70171 1 3.59654 1.10173 2.82715 1.28027C2.59794 1.33348 2.40597 1.39193 2.25684 1.45215L2.14746 1.49902C2.28072 1.56321 2.45214 1.6231 2.66211 1.67871L2.82715 1.71973C3.59654 1.89827 4.70171 2 6 2C7.29829 2 8.40346 1.89827 9.17285 1.71973C9.40206 1.66652 9.59403 1.60807 9.74316 1.54785L9.85156 1.49902C9.7193 1.43682 9.54788 1.3769 9.33789 1.32129L9.17285 1.28027C8.40346 1.10173 7.29829 1 6 1Z',
            fill: '#666666',
            key: '13d71y',
        },
    ],
...
const DateTime = [
    [
        'path',
        {
            d: 'M4 1H8V0H9V1H10.5C11.3284 1 12 1.67157 12 2.5V10.5C12 11.3284 11.3284 12 10.5 12H1.5C0.671573 12 0 11.3284 0 10.5V2.5C0 1.67157 0.671573 1 1.5 1H3V0H4V1ZM1.5 2C1.22386 2 1 2.22386 1 2.5V10.5C1 10.7761 1.22386 11 1.5 11H10.5C10.7761 11 11 10.7761 11 10.5V2.5C11 2.22386 10.7761 2 10.5 2H9V4H8V2H4V4H3V2H1.5ZM6 6.79297L7.35352 8.14648L6.64648 8.85352L5.29297 7.5C5.1368 7.34383 5.0376 7.14133 5.00879 6.9248L5 6.79297V4H6V6.79297Z',
            fill: '#666666',
            key: 'k8nooi',
        },
    ],
...
const Diamond = [
    [
        'path',
        {
            'fill-rule': 'evenodd',
            'clip-rule': 'evenodd',
            d: 'M3.26631 1H8.78068C9.11693 1 9.43066 1.16899 9.61568 1.44975L11.6988 4.61094C11.9549 4.99947 11.9091 5.51326 11.5884 5.8504L7.08683 10.5829C6.51588 11.1831 5.56642 11.2069 4.96618 10.6359L0.414213 5.85316C0.0911167 5.51349 0.0473492 4.99497 0.308938 4.60595L2.43647 1.44199C2.62225 1.1657 2.93336 1 3.26631 1ZM8.78068 2H3.26631L1.13878 5.16395L5.65539 9.91134C5.85547 10.1017 6.17195 10.0937 6.36227 9.89367L10.8638 5.16119L8.78068 2Z',
            fill: '#666666',
            key: 'dho3x9',
        },
    ],
 ...
 *
 */
const EmoticonDiscouraged = [
    [
        'path',
        {
            d: 'M6 0C9.31371 0 12 2.68629 12 6C12 9.31371 9.31371 12 6 12C2.68629 12 0 9.31371 0 6C0 2.68629 2.68629 0 6 0ZM6 1C3.23858 1 1 3.23858 1 6C1 8.76142 3.23858 11 6 11C8.76142 11 11 8.76142 11 6C11 3.23858 8.76142 1 6 1ZM6 7.16504C7.00941 7.16504 7.95079 7.59614 8.61035 8.33398L7.86426 9L7.73145 8.86133C7.27072 8.41869 6.65611 8.16504 6 8.16504C5.2838 8.16505 4.61693 8.46749 4.14551 8.98828L3.4043 8.31738L3.5498 8.16602C4.19736 7.53089 5.06987 7.16505 6 7.16504ZM5 5.5H3.5V4H5V5.5ZM8.5 5.5H7V4H8.5V5.5Z',
            fill: '#666666',
            key: '13eprt',
        },
    ],
...
const Emoticon = [
    [
        'path',
        {
            d: 'M6 0C9.31371 0 12 2.68629 12 6C12 9.31371 9.31371 12 6 12C2.68629 12 0 9.31371 0 6C0 2.68629 2.68629 0 6 0ZM6 1C3.23858 1 1 3.23858 1 6C1 8.76142 3.23858 11 6 11C8.76142 11 11 8.76142 11 6C11 3.23858 8.76142 1 6 
V6H10.004V4.5H8.504C7.7244 4.49992 7.08355 3.9051 7.01084 3.14453L7.004 3V1H2.504C2.25861 1.00008 2.05414 1.17696 2.01182 1.41016L2.004 1.5V5.5H1.004V1.5C1.004 0.720381 1.59893 0.0796252 2.35947 0.00683594L2.504 0H7.504ZM8.004 3C8.004 3.24541 8.18099 3.44979 8.41416 3.49219L8.504 3.5H9.85752L9.56553 3.15039L9.25791 2.79102L8.83506 2.30859L8.46006 1.89746L8.13877 1.56055L8.004 1.42676V3Z',
            fill: '#666666',
            key: '1935l6',
        },
    ],
 ...
 */
const Erase = [
    ['path', { d: 'M12 11V12H7V11H12Z', fill: '#666666', key: '13ilxl' }],
    [
        'path',
        {
            d: 'M6.793 0.500018C7.18352 0.109535 7.81655 0.109508 8.20706 0.500018L11.5 3.79299C11.8903 4.18352 11.8904 4.8166 11.5 5.20705L5.20706 11.5C4.81661 11.8904 4.18353 11.8903 3.793 11.5L0.500028 8.20705C0.109516 7.81654 0.109541 7.18351 0.500028 6.79299L6.793 0.500018ZM1.20706 7.50002L4.50003 10.793L5.79202 9.49904L2.50003 6.20705L1.20706 7.50002ZM3.20706 5.50002L6.49905 8.79201L10.792 4.49904L7.50003 1.20705L3.20706 5.50002Z',
            fill: '#666666',
            key: '1ljowl',
        },
    ],
...
const ExchangeUd = [
    [
        'path',
        {
            d: 'M4 9.89689C3.99986 10.311 3.66412 10.6469 3.25 10.6469C3.09087 10.6469 2.93679 10.5956 2.80957 10.5033L2.71973 10.4272L0.646484 8.35392L1.35352 7.64689L3 9.29338V1.00041H4V9.89689ZM8.26953 1.11466C8.55876 0.873638 8.97634 0.886865 9.24902 1.13029L9.32617 1.21037L11.3838 3.68009L10.6162 4.32072L9 2.38224V10.5004H8V1.69084C8 1.46836 8.0987 1.25716 8.26953 1.11466Z',
            fill: '#666666',
            key: 'm0n9uv',
        },
    ],
 ...
 *
 */
const ExclamatoryTriangle = [
    [
        'path',
        {
            d: 'M5.25542 0.712836C5.97468 0.301866 6.89128 0.552199 7.3023 1.27143L11.5796 8.7558C11.7091 8.98237 11.7769 9.23902 11.7769 9.49995C11.7769 10.3283 11.1053 10.9999 10.2769 10.9999H1.7232C1.46224 10.9999 1.20565 10.9321 0.979056 10.8027C0.259862 10.3917 0.00962983 9.47504 0.420462 8.7558L4.69781 1.27143C4.83066 1.03897 5.02297 0.845705 5.25542 0.712836ZM6.43413 1.76752C6.29713 1.52781 5.99126 1.44404 5.75152 1.581C5.6741 1.62528 5.61023 1.69009 5.56597 1.76752L1.28863 9.2519C1.1518 9.49162 1.23547 9.79755 1.47515 9.93452C1.55064 9.97761 1.63627 9.99994 1.7232 9.99995H10.2769C10.553 9.9999 10.7769 9.77605 10.7769 9.49995C10.7769 9.41295 10.7537 9.32743 10.7105 9.2519L6.43413 1.76752ZM6.49956 8.99995H5.49956V7.99995H6.49956V8.99995ZM6.49956 6.99995H5.49956V3.49995H6.49956V6.99995Z',
            fill: '#666666',
            key: '53zl2',
        },
    ],
...
const FileAdd = [
    [
        'path',
        {
            d: 'M9.5 0C10.2797 0 10.9204 0.594849 10.9932 1.35547L11 1.5V5H10V1.5C10 1.25454 9.82309 1.05015 9.58984 1.00781L9.5 1H9V2C9 2.51284 8.61355 2.9354 8.11621 2.99316L8 3H4C3.48716 3 3.0646 2.61355 3.00684 2.11621L3 2V1H2.5C2.25454 1 2.05015 1.17691 2.00781 1.41016L2 1.5V10.5C2 10.7455 2.17691 10.9499 2.41016 10.9922L2.5 11H6V12H2.5C1.72033 12 1.07955 11.4052 1.00684 10.6445L1 10.5V1.5C1 0.720327 1.59485 0.0795522 2.35547 0.00683594L2.5 0H9.5ZM10 9H12V10H10V12H9V10H7V9H9V7H10V9ZM4 2H8V1H4V2Z',
            fill: '#666666',
            key: 'r3vnxu',
        },
    ],
...
const File = [
    [
        'path',
        {
            d: 'M7.58594 0C7.98371 4.00259e-05 8.36522 0.158184 8.64648 0.439453L10.5605 2.35352C10.8418 2.63478 11 3.01629 11 3.41406V10.5C11 11.3284 10.3284 12 9.5 12H2.5C1.67157 12 1 11.3284 1 10.5V1.5C1 0.671573 1.67157 0 2.5 0H7.58594ZM2.5 1C2.22386 1 2 1.22386 2 1.5V10.5C2 10.7761 2.22386 11 2.5 11H9.5C9.77614 11 10 10.7761 10 10.5V4H8.5C7.72033 4 7.07955 3.40515 7.00684 2.64453L7 2.5V1H2.5ZM8 10H3V9H8V10ZM6 8H3V7H6V8ZM8 2.5C8 2.74546 8.17691 2.94985 8.41016 2.99219L8.5 3H9.79297L8 1.20703V2.5Z',
            fill: '#666666',
            key: 'cgwaqj',
        },
    ],
...
const FixedPosition = [
    [
        'path',
        {
            d: 'M6 0C9.31371 0 12 2.68629 12 6C12 9.31371 9.31371 12 6 12C2.68629 12 0 9.31371 0 6C0 2.68629 2.68629 0 6 0ZM6.5 3H5.5V1.02441C3.13777 1.25894 1.25894 3.13777 1.02441 5.5H3V6.5H1.02441C1.25893 8.8622 3.13782 10.74 5.5 10.9746V9H6.5V10.9746C8.86218 10.74 10.7411 8.8622 10.9756 6.5H9V5.5H10.9756C10.7411 3.13777 8.86223 1.25894 6.5 1.02441V3ZM6 4C7.10457 4 8 4.89543 8 6C8 7.10457 7.10457 8 6 8C4.89543 8 4 7.10457 4 6C4 4.89543 4.89543 4 6 4ZM6 5C5.44772 5 5 5.44772 5 6C5 6.55228 5.44772 7 6 7C6.55228 7 7 6.55228 7 6C7 5.44772 6.55228 5 6 5Z',
            fill: '#666666',
            key: 'qmyx3w',
        },
    ],
...
const FolderOpen = [
    [
        'path',
        {
            d: 'M4.08594 1C4.43394 1.00004 4.76927 1.12123 5.03613 1.33984L5.14648 1.43945L6.56055 2.85352C6.63556 2.92853 6.73248 2.97765 6.83594 2.99414L6.91406 3H10.3477C11.1758 3.00036 11.8477 3.67179 11.8477 4.5C11.8477 4.5709 11.842 4.64172 11.832 4.71191L11.1182 9.71191C11.0126 10.4508 10.3792 10.9998 9.63281 11H1.5C0.720327 11 0.0795524 10.4052 0.00683594 9.64453L0 9.5V2.5C0 1.72033 0.594849 1.07955 1.35547 1.00684L1.5 1H4.08594ZM3.36719 4C3.11856 4.00021 2.90823 4.18352 2.87305 4.42969L2.1543 9.46484L2.15332 9.5C2.15332 9.77614 2.37718 10 2.65332 10H9.63281C9.8815 9.99985 10.0928 9.81653 10.1279 9.57031L10.8457 4.53516L10.8477 4.5C10.8477 4.22408 10.6235 4.00036 10.3477 4H3.36719ZM1.5 2C1.25454 2 1.05015 2.17691 1.00781 2.41016L1 2.5V9.5C1 9.66758 1.08342 9.81455 1.20996 9.90527C1.1738 9.77624 1.15332 9.64058 1.15332 9.5C1.15332 9.42911 1.15796 9.35826 1.16797 9.28809L1.88281 4.28809C1.98838 3.54927 2.62091 3.00021 3.36719 3H5.29297L4.43945 2.14648C4.36444 2.07147 4.26752 2.02235 4.16406 2.00586L4.08594 2H1.5ZM11 2H7V1H11V2Z',
            fill: '#666666',
            key: '4vf70l',
        },
    ],
...
const Folder = [
    [
        'path',
        {
            'fill-rule': 'evenodd',
            'clip-rule': 'evenodd',
            d: 'M1.5 1H4.08579C4.48361 1 4.86514 1.15804 5.14645 1.43934L6.56066 2.85355C6.65443 2.94732 6.78161 3 6.91421 3H10.5C11.3284 3 12 3.67157 12 4.5V9.5C12 10.3284 11.3284 11 10.5 11H1.5C0.671573 11 0 10.3284 0 9.5V2.5C0 1.67157 0.671573 1 1.5 1ZM4.08579 2H1.5C1.22386 2 1 2.22386 1 2.5V9.5C1 9.77614 1.22386 10 1.5 10H10.5C10.7761 10 11 9.77614 11 9.5V4.5C11 4.22386 10.7761 4 10.5 4H6.91421C6.51639 4 6.13486 3.84196 5.85355 3.56066L4.43934 2.14645C4.34557 2.05268 4.21839 2 4.08579 2Z',
            fill: '#666666',
            key: '197ryg',
        },
    ],
    ['path', { d: 'M11 1V2H7V1H11Z', fill: '#666666', key: '74tu8i' }],
]; //eslint-disable-line no-shadow-restricted-names
...
const Label = [
    [
        'path',
        {
            d: 'M10.4999 0C11.3282 0.000128836 11.9999 0.671652 11.9999 1.5V4.72266C11.9999 5.11928 11.8422 5.50015 11.5624 5.78125L5.8192 11.5518C5.23525 12.1382 4.28634 12.1407 3.69908 11.5576L0.459823 8.33984C-0.128271 7.75526 -0.130415 6.80409 0.45494 6.2168L6.21666 0.44043C6.49797 0.158436 6.88085 0.00010389 7.27916 0H10.4999ZM7.27916 1C7.14654 1.0001 7.01836 1.05263 6.92467 1.14648L1.16295 6.92285C0.968054 7.1186 0.969022 7.43606 1.1649 7.63086L4.40318 10.8477C4.59888 11.0421 4.91552 11.0411 5.11021 10.8457L10.8544 5.0752C10.9474 4.98153 10.9999 4.85467 10.9999 4.72266V1.5C10.9999 1.22394 10.7759 1.00013 10.4999 1H7.27916ZM7.74986 2.5C8.71636 2.5 9.49986 3.2835 9.49986 4.25C9.49986 5.2165 8.71636 6 7.74986 6C6.78346 5.99989 5.99986 5.21643 5.99986 4.25C5.99986 3.28357 6.78346 2.50011 7.74986 2.5ZM7.74986 3.5C7.33575 3.50011 6.99986 3.83586 6.99986 4.25C6.99986 4.66414 7.33575 4.99989 7.74986 5C8.16408 5 8.49986 4.66421 8.49986 4.25C8.49986 3.83579 8.16408 3.5 7.74986 3.5Z',
            fill: '#666666',
            key: '1iag7e',
        },
    ],
...
const Lock = [
    [
        'path',
        {
.93298 1 5 1ZM6.5 6C6.77614 6 7 6.22386 7 6.5C7 6.77614 6.77614 7 6.5 7C6.22386 7 6 6.77614 6 6.5C6 6.22386 6.22386 6 6.5 6ZM9 6C9.27614 6 9.5 6.22386 9.5 6.5C9.5 6.77614 9.27614 7 9 7C8.72386 7 8.5 6.77614 8.5 6.5C8.5 6.22386 8.72386 6 9 6ZM3.5 2C3.77614 2 4 2.22386 4 2.5C4 2.77614 3.77614 3 3.5 3C3.22386 3 3 2.77614 3 2.5C3 2.22386 3.22386 2 3.5 2ZM6.5 2C6.77614 2 7 2.22386 7 2.5C7 2.77614 6.77614 3 6.5 3C6.22386 3 6 2.77614 6 2.5C6 2.22386 6.22386 2 6.5 2Z',
            fill: '#666666',
            key: '17c643',
        },
    ],
...
const Message = [
    [
        'path',
        {
            d: 'M10.5 1C11.3284 1 12 1.67157 12 2.5V8.5C12 9.32843 11.3284 10 10.5 10H4.70605L3.19531 11.5117C2.94932 11.7577 2.56553 11.7827 2.29199 11.5859L2.20508 11.5117C2.07401 11.3806 2.00011 11.203 2 11.0176V10H1.5C0.720327 10 0.0795521 9.40515 0.00683594 8.64453L0 8.5V2.5C0 1.67157 0.671573 1 1.5 1H10.5ZM1.5 2C1.22386 2 1 2.22386 1 2.5V8.5C1 8.77614 1.22386 9 1.5 9H2.2998C2.6864 9 3 9.3136 3 9.7002V10.292L4.08789 9.20508C4.1929 9.10007 4.32783 9.03187 4.47266 9.00879L4.58301 9H10.5C10.7761 9 11 8.77614 11 8.5V2.5C11 2.22386 10.7761 2 10.5 2H1.5ZM4 6H3V5H4V6ZM6.5 6H5.5V5H6.5V6ZM9 6H8V5H9V6Z',
            fill: '#666666',
            key: '1fdd7y',
        },
    ],
...
const ParameterSetting = [
    [
        'path',
        {
            d: 'M4 1C4.65293 1 5.20703 1.41766 5.41309 2H11V3H5.41309C5.20703 3.58234 4.65293 4 4 4C3.34707 4 2.79297 3.58234 2.58691 3H1V2H2.58691C2.79297 1.41766 3.34707 1 4 1ZM4 2C3.72386 2 3.5 2.22386 3.5 2.5C3.5 2.77614 3.72386 3 4 3C4.27614 3 4.5 2.77614 4.5 2.5C4.5 2.22386 4.27614 2 4 2Z',
            fill: '#666666',
            key: 'kfldo1',
        },
    ],
    [
        'path',
        {
            d: 'M4 8C4.65293 8 5.20703 8.41766 5.41309 9H11V10H5.41309C5.20703 10.5823 4.65293 11 4 11C3.34707 11 2.79297 10.5823 2.58691 10H1V9H2.58691C2.79297 8.41766 3.34707 8 4 8ZM4 9C3.72386 9 3.5 9.22386 3.5 9.5C3.5 9.77614 3.72386 10 4 10C4.27614 10 4.5 9.77614 4.5 9.5C4.5 9.22386 4.27614 9 4 9Z',
            fill: '#666666',
            key: '1hbtay',
        },
    ],
...
const Picture = [
    ...
    [
        'path',
        {
            d: 'M8.5 3C9.32843 3 10 3.67157 10 4.5C10 5.32843 9.32843 6 8.5 6C7.67157 6 7 5.32843 7 4.5C7 3.67157 7.67157 3 8.5 3ZM8.5 4C8.22386 4 8 4.22386 8 4.5C8 4.77614 8.22386 5 8.5 5C8.77614 5 9 4.77614 9 4.5C9 4.22386 8.77614 4 8.5 4Z',
            fill: '#666666',
            key: 'jm2uok',
        },
    ],
...
const Play = [
    [
        'path',
        {
            'fill-rule': 'evenodd',
            'clip-rule': 'evenodd',
            d: '
5 1.6928 1.5 2.45898C1.50033 3.22489 2.12171 3.8457 2.8877 3.8457C3.6535 3.84549 4.27409 3.22476 4.27441 2.45898C4.27441 1.69293 3.6537 1.0715 2.8877 1.07129ZM9.28418 1.07129C8.51802 1.07132 7.89648 1.69282 7.89648 2.45898C7.89681 3.22487 8.51822 3.84567 9.28418 3.8457C10.05 3.84549 10.6706 3.22476 10.6709 2.45898C10.6709 1.69293 10.0502 1.0715 9.28418 1.07129Z',
            fill: '#666666',
            key: 'k56g0q',
        },
    ],
...
const Question = [
    [
        'path',
        {
            d: 'M6 0C9.31371 0 12 2.68629 12 6C12 9.31371 9.31371 12 6 12C2.68629 12 0 9.31371 0 6C0 2.68629 2.68629 0 6 0ZM6 1C3.23858 1 1 3.23858 1 6C1 8.76142 3.23858 11 6 11C8.76142 11 11 8.76142 11 6C11 3.23858 8.76142 1 6 1ZM6.5 9.5H5.5V8H6.5V9.5ZM6 2.5C7.07931 2.50001 7.95386 3.37484 7.9541 4.4541C7.9541 5.33729 7.36869 6.08395 6.56445 6.32617L6.5 6.3418V7.5H5.5V5.40918H6C6.52717 5.40917 6.9541 4.98128 6.9541 4.4541C6.95386 3.92713 6.52703 3.50001 6 3.5C5.51062 3.5 5.10709 3.86825 5.05176 4.34277L5.0459 4.4541H4.0459C4.04614 3.37484 4.92068 2.5 6 2.5Z',
            fill: '#666666',
            key: '11rzra',
        },
    ],
...
const Refresh = [
    [
        'path',
        {
            'fill-rule': 'evenodd',
            'clip-rule': 'evenodd',
            d: 'M6 1V0H1V1H2.682L2.55883 1.08426C1.01152 2.16943 0 3.96659 0 6C0 8.50064 1.54404 10.7121 3.838 11.5985L4.19844 10.6657L3.99604 10.5824C2.19653 9.79512 1 8.0096 1 6C1 3.23858 3.23858 1 6 1ZM12 6C12 3.52058 10.482 1.32401 8.21668 0.422909L7.84707 1.3521L8.05424 1.43994C9.82692 2.23897 11 4.01017 11 6C11 8.68876 8.87769 10.8818 6.21689 10.9954L6 11V12H11V11L9.317 10.999L9.44117 10.9157C10.9885 9.83057 12 8.03341 12 6Z',
            fill: '#666666',
            key: '38tqu8',
        },
    ],
 ...
 *
 */
const StringTypeBlob = [
    [
        'path',
        {
            d: 'M10.5 1C11.3284 1 12 1.67157 12 2.5V9.5C12 10.3284 11.3284 11 10.5 11H1.5C0.671573 11 0 10.3284 0 9.5V2.5C0 1.67157 0.671573 1 1.5 1H10.5ZM1.5 2C1.22386 2 1 2.22386 1 2.5V9.5C1 9.77614 1.22386 10 1.5 10H10.5C10.7761 10 11 9.77614 11 9.5V2.5C11 2.22386 10.7761 2 10.5 2H1.5ZM5.5 6C6.32843 6 7 6.67157 7 7.5C7 8.32843 6.32843 9 5.5 9C4.67157 9 4 8.32843 4 7.5C4 6.67157 4.67157 6 5.5 6ZM5.5 7C5.22386 7 5 7.22386 5 7.5C5 7.77614 5.22386 8 5.5 8C5.77614 8 6 7.77614 6 7.5C6 7.22386 5.77614 7 5.5 7ZM8.5 4C9.32843 4 10 4.67157 10 5.5C10 6.32843 9.32843 7 8.5 7C7.67157 7 7 6.32843 7 5.5C7 4.67157 7.67157 4 8.5 4ZM3.5 3C4.32843 3 5 3.67157 5 4.5C5 5.32843 4.32843 6 3.5 6C2.67157 6 2 5.32843 2 4.5C2 3.67157 2.67157 3 3.5 3ZM8.5 5C8.22386 5 8 5.22386 8 5.5C8 5.77614 8.22386 6 8.5 6C8.77614 6 9 5.77614 9 5.5C9 5.22386 8.77614 5 8.5 5ZM3.5 4C3.22386 4 3 4.22386 3 4.5C3 4.77614 3.22386 5 3.5 5C3.77614 5 4 4.77614 4 4.5C4 4.22386 3.77614 4 3.5 4Z',
            fill: '#666666',
            key: 'ishofb',
        },
    ],
 ...
 *
 */
const StringTypeFloat = [
    [
        'path',
        {
            d: 'M10 1C10.5523 1 11 1.67157 11 2.5V9.5C11 10.3284 10.5523 11 10 11H2C1.44772 11 1 10.3284 1 9.5V2.5C1 1.67157 1.44772 1 2 1H10ZM2.2998 2C2.13421 2.00018 2 2.22397 2 2.5V9.5C2 9.77603 2.13421 9.99982 2.2998 10H9.7002C9.86579 9.99982 10 9.77603 10 9.5V2.5C10 2.22397 9.86579 2.00018 9.7002 2H2.2998ZM4 9H3V8H4V9ZM7 3C7.55228 3 8 3.44772 8 4V8H9V9H5V8H7V4H6V3H7Z',
            fill: '#666666',
            key: 'yz2o6j',
        },
    ],
...
const Tick = [
    [
        'path',
        {
            d: 'M6 0C9.31371 0 12 2.68629 12 6C12 9.31371 9.31371 12 6 12C2.68629 12 0 9.31371 0 6C0 2.68629 2.68629 0 6 0ZM6 1C3.23858 1 1 3.23858 1 6C1 8.76142 3.23858 11 6 11C8.76142 11 11 8.76142 11 6C11 3.23858 8.76142 1 6 1ZM9.38379 4.88379L6.2373 8.03027C5.87682 8.39072 5.30927 8.41829 4.91699 8.11328L4.82324 8.03027L3.17676 6.38379L3.88379 5.67676L5.53027 7.32324L8.67676 4.17676L9.38379 4.88379Z',
            fill: '#666666',
            key: 'w1dqfi',
        },
    ],
...
const Trajectory = [
    [
        'path',
        {
            d: 'M2 0.5C2.36997 0.5 2.69227 0.701335 2.86523 1H8.25C9.76878 1 11 2.23122 11 3.75C11 5.21238 9.85854 6.40832 8.41797 6.49512L8.25 6.5H3.75C2.7835 6.5 2 7.2835 2 8.25C2 9.16816 2.7071 9.92112 3.60645 9.99414L3.75 10H9.13477C9.30773 9.70133 9.63003 9.5 10 9.5C10.5523 9.5 11 9.94772 11 10.5C11 11.0523 10.5523 11.5 10 11.5C9.63003 11.5 9.30773 11.2987 9.13477 11H3.75C2.23122 11 1 9.76878 1 8.25C1 6.78762 2.14146 5.59168 3.58203 5.50488L3.75 5.5H8.25C9.2165 5.5 10 4.7165 10 3.75C10 2.83184 9.2929 2.07888 8.39355 2.00586L8.25 2H2.86523C2.69227 2.29867 2.36997 2.5 2 2.5C1.44772 2.5 1 2.05228 1 1.5C1 0.947715 1.44772 0.5 2 0.5Z',
            fill: '#666666',
            key: 'lmuaw2',
        },
    ],
...
const Unlock = [
    [
        'path',
        {
            d: 'M9 0C10.5975 0 11.9036 1.24866 11.9951 2.82324L12 3H11C11 1.89543 10.1046 1 9 1C7.9457 1 7.08229 1.81581 7.00586 2.85059L7 3V4H8.5C9.32843 4 10 4.67157 10 5.5V10.5C10 11.3284 9.32843 12 8.5 12H1.5C0.671573 12 0 11.3284 0 10.5V5.5C0 4.67157 0.671573 4 1.5 4H6V3C6 1.34315 7.34315 0 9 0ZM1.5 5C1.22386 5 1 5.22386 1 5.5V10.5C1 10.7761 1.22386 11 1.5 11H8.5C8.77614 11 9 10.7761 9 10.5V5.5C9 5.22386 8.77614 5 8.5 5H1.5ZM5.5 9H4.5V7H5.5V9Z',
            fill: '#666666',
            key: '1iwh6x',
        },
    ],
...
const Upload = [
    [
        'path',
        {
            d: 'M5.55859 1.73535C5.80267 1.49129 6.19831 1.49128 6.44238 1.73535L10.6406 5.93359C10.7574 6.05066 10.8231 6.20963 10.8232 6.375C10.823 6.71984 10.5431 6.99976 10.1982 7H9V11C8.99979 11.5125 8.61416 11.9362 8.11719 11.9941L8 12H4C3.44805 11.9998 3.00023 11.552 3 11V7H1.80176C1.66966 6.99991 1.54128 6.95823 1.43555 6.88184L1.36035 6.81738C1.11628 6.57331 1.11628 6.17767 1.36035 5.93359L5.55859 1.73535ZM2.70605 6H3.375C3.6886 6.00021 3.94854 6.23196 3.99316 6.5332L4 6.625V11H8V6.625C8.00023 6.28015 8.28015 6.00023 8.625 6H9.29297L6 2.70703L2.70605 6ZM10 0C10.5128 0 10.9354 0.38645 10.9932 0.883789L11 1V2H10V1H2V2H1V1C1 0.487164 1.38645 0.064601 1.88379 0.00683594L2 0H10Z',
            fill: '#666666',
            key: '15qsls',
        },
    ],
...
const UserCCList = [
    [
        'path',
        {
            d: 'M5.99999 0C8.20913 0 9.99999 1.79086 9.99999 4C9.99999 4.32086 9.96183 4.6369 9.88769 4.94336L9.82616 5.17188L8.86913 4.87891C8.95543 4.59679 8.99999 4.30167 8.99999 4C8.99999 2.34315 7.65685 1 5.99999 1C4.34319 1.00006 2.99999 2.34318 2.99999 4C2.99999 5.59768 4.2494 6.90387 5.82421 6.99512L5.99999 7V8H3.56152C2.63719 8.00006 1.82419 8.59206 1.53319 9.45605L1.48534 9.62109L1.29589 10.3789C1.22904 10.6466 1.39153 10.9182 1.65917 10.9854L1.71972 10.9961L1.78124 11H5.99999V12H1.78124C1.6586 12 1.53596 11.9848 1.41698 11.9551C0.660757 11.766 0.183112 11.0337 0.296867 10.2783L0.325187 10.1357L0.51464 9.37891C0.833748 8.10247 1.90905 7.17333 3.19042 7.02148L3.3623 7.00586L3.23827 6.89355C2.52027 6.20801 2.05689 5.25741 2.00487 4.19922L1.99999 4C1.99999 1.7909 3.7909 5.81295e-05 5.99999 0ZM11.375 7C11.6886 7 11.9483 7.23105 11.9932 7.53223L12 7.625V11H11V8.70703L7.85351 11.8535L7.14648 11.1465L10.293 8H7.99999V7H11.375ZM4.72167 8.28516C4.8848 8.55002 5.12621 8.75825 5.41015 8.87988L5.55566 8.93359L5.25976 9.88867C4.74507 9.72929 4.29797 9.40653 3.98241 8.97559L3.87011 8.80859L4.72167 8.28516Z',
            fill: '#666666',
            key: 'bn89wz',
        },
    ],
...
const UserGroup = [
    [
        'path',
        {
            d: 'M4.5 0C5.93717 0 7.17102 0.866648 7.70996 2.10547C7.96494 2.03601 8.23007 2 8.5 2C10.1569 2 11.5 3.34315 11.5 5C11.5 5.87071 11.1266 6.65217 10.5342 7.2002C11.0013 7.41898 11.3817 7.8048 11.5898 8.29492L11.6504 8.4541L11.9229 9.27148C12.152 9.95954 11.7798 10.7033 11.0918 10.9326C11.0026 10.9623 10.9106 10.9821 10.8174 10.9922L10.6768 11H8.96484C8.85482 11.4454 8.51532 11.8206 8.04199 11.9521C7.92771 11.9839 7.80903 12 7.69043 12H1.31836C0.59298 12 0.00488281 11.4119 0.00488281 10.6865C0.00488831 10.5691 0.0206607 10.4521 0.0517578 10.3389L0.540039 8.56348C0.793769 7.64013 1.63324 7 2.59082 7H8.5C9.60457 7 10.5 6.10457 10.5 5C10.5 3.89543 9.60457 3 8.5 3C8.31937 3 8.14254 3.02403 7.97266 3.07031C7.98991 3.21118 8 3.35448 8 3.5C8 5.433 6.433 7 4.5 7C2.567 7 1 5.433 1 3.5C1 1.567 2.567 0 4.5 0ZM2.59082 8C2.08355 8 1.6384 8.33903 1.50391 8.82812L1.01562 10.6035C1.00821 10.6305 1.00489 10.6585 1.00488 10.6865C1.00488 10.8596 1.14527 11 1.31836 11H7.69043C7.71866 11 7.74721 10.9958 7.77441 10.9883C7.94087 10.9418 8.03838 10.7691 7.99219 10.6025L7.49902 8.8252C7.37199 8.36798 6.97325 8.04274 6.50684 8.00391L6.41309 8H2.59082ZM6.33203 8.93555C5.95257 9.58905 5.26153 10 4.5 10C3.8252 10 3.20471 9.67738 2.80762 9.14648L2.71387 9.00879L3.55762 8.47266C3.76557 8.80006 4.11665 9 4.5 9C4.85502 9 5.18249 8.82886 5.39355 8.54492L5.4668 8.43262L6.33203 8.93555ZM8.21484 8C8.32155 8.17052 8.40704 8.35733 8.46289 8.55859L8.86328 10H10.6768C10.7102 9.99997 10.7436 9.99493 10.7754 9.98438C10.9161 9.93746 11.0012 9.79983 10.9883 9.6582L10.9736 9.58789L10.7012 8.77051C10.5606 8.34876 10.1868 8.05323 9.75195 8.00684L9.63281 8H8.21484ZM4.5 1C3.11929 1 2 2.11929 2 3.5C2 4.88071 3.11929 6 4.5 6C5.88071 6 7 4.88071 7 3.5C7 2.11929 5.88071 1 4.5 1Z',
            fill: '#666666',
            key: 'w2ik4y',
        },
    ],
...
var luiIconIcons = /*#__PURE__*/Object.freeze({
    __proto__: null,
    AnnotateCc: AnnotateCc,
    AnnotateSign: AnnotateSign,
    ...
    Earthset: Earthset,
    Edit: Edit,
    EmoticonDiscouraged: EmoticonDiscouraged,
    Emoticon: Emoticon,
    Entrust: Entrust,
    Erase: Erase,
    ExchangeUd: ExchangeUd,
    ExchangeUdinvertedOrder: ExchangeUdinvertedOrder,
    ExchangeUdorder: ExchangeUdorder,
    ExclamatoryTriangle: ExclamatoryTriangle,
    ...
    LevelSame: LevelSame,
    LeftPackup: LeftPackup,
    Like: Like,
    Loading: Loading,
    Lock: Lock,
    LogoDingding: LogoDingding,
    LogoFeishu: LogoFeishu,
    LogoKK: LogoKK,
    LogoQQ: LogoQQ,
    ...
    SignEqual: SignEqual,
    SignMinus: SignMinus,
    SignExclamatory: SignExclamatory,
    SignPlus: SignPlus,
    SignTick: SignTick,
    SignPound: SignPound,
    Signin: Signin,
    SortDrag: SortDrag,
    SortFilterDown: SortFilterDown,
    SortInvertedOrder: SortInvertedOrder,
    SortFilterUp: SortFilterUp,
    SortOrder: SortOrder,
    Stop: Stop,
    Sort: Sort,
    StringTypeBigDeciaml: StringTypeBigDeciaml,
    StringTypeBlob: StringTypeBlob,
    StringTypeDouble: StringTypeDouble,
    StringTypeLong: StringTypeLong,
    StringTypeFloat: StringTypeFloat,
    Setting: Setting,
    SuccessfulTranslation: SuccessfulTranslation,
    Save: Save,
    Tick: Tick,
    Time: Time,
    TickUnselected: TickUnselected,
    Timing: Timing,
    Tool: Tool,
    TowardsDown: TowardsDown,
...
export { AnnotateCc, AnnotateCc as AnnotateCcIcon, AnnotateSign, AnnotateSign as AnnotateSignIcon, ArrowDoubleLeft, ArrowDoubleLeft as ArrowDoubleLeftIcon, ArrowDoubleRight, ArrowDoubleRight as ArrowDoubleRightIcon, ArrowDown, ArrowDown as ArrowDownIcon, ArrowLeft, ArrowLeft as ArrowLeftIcon, ArrowRight, ArrowRight as ArrowRightIcon, ArrowUp, ArrowUp as ArrowUpIcon, BatchAdd, BatchAdd as BatchAddIcon, BatchDelete, BatchDelete as BatchDeleteIcon, BookMark, BookMark as BookMarkIcon, BtnAdd, BtnAdd as BtnAddIcon, BtnChange, BtnChange as BtnChangeIcon, BtnDelete, BtnDelete as BtnDeleteIcon, BtnFold, BtnFold as BtnFoldIcon, BtnMore, BtnMore as BtnMoreIcon, BtnPlay, BtnPlay as BtnPlayIcon, BtnUnfold, BtnUnfold as BtnUnfoldIcon, Bug, Bug as BugIcon, Calendar, Calendar as CalendarIcon, Change, Change as ChangeIcon, ChartHistogram, ChartHistogram as ChartHistogramIcon, Checkin, Checkin as CheckinIcon, Cloud, Cloud as CloudIcon, Collection, Collection as CollectionIcon, Confirm, Confirm as ConfirmIcon, Copy, Copy as CopyIcon, Cross, Cross as CrossIcon, Data, DataExport, DataExport as DataExportIcon, Data as DataIcon, DataImport, DataImport as DataImportIcon, DataPermission, DataPermission as DataPermissionIcon, DataSwitch, DataSwitch as DataSwitchIcon, DateTime, DateTime as DateTimeIcon, Delete, Delete as DeleteIcon, Dialogue, Dialogue as DialogueIcon, Diamond, Diamond as DiamondIcon, DirectionRightUp, DirectionRightUp as DirectionRightUpIcon, Download, Download as DownloadIcon, Earth, Earth as EarthIcon, Earthset, Earthset as EarthsetIcon, Edit, Edit as EditIcon, Emoticon, EmoticonDiscouraged, EmoticonDiscouraged as EmoticonDiscouragedIcon, Emoticon as EmoticonIcon, Entrust, Entrust as EntrustIcon, Erase, Erase as EraseIcon, ExchangeUd, ExchangeUd as ExchangeUdIcon, ExchangeUdinvertedOrder, ExchangeUdinvertedOrder as ExchangeUdinvertedOrderIcon, ExchangeUdorder, ExchangeUdorder as ExchangeUdorderIcon, Exclamatory, Exclamatory as ExclamatoryIcon, ExclamatoryTriangle, ExclamatoryTriangle as ExclamatoryTriangleIcon, Experiment, Experiment as ExperimentIcon, Extport, Extport as ExtportIcon, File, FileAdd, FileAdd as FileAddIcon, File as FileIcon, FilePending, FilePending as FilePendingIcon, FileProcessed, FileProcessed as FileProcessedIcon, Fire, Fire as FireIcon, FixedPosition, FixedPosition as FixedPositionIcon, Folder, Folder as FolderIcon, FolderOpen, FolderOpen as FolderOpenIcon, FullScreen, FullScreenExit, FullScreenExit as FullScreenExitIcon, FullScreen as FullScreenIcon, Funnel, Funnel as FunnelIcon, HalfScreen, HalfScreenExit, HalfScreenExit as HalfScreenExitIcon, HalfScreen as HalfScreenIcon, Heart, Heart as HeartIcon, Hide, Hide as HideIcon, HidePassowrd, HidePassowrd as HidePassowrdIcon, HomePage, HomePage as HomePageIcon, Import, Import as ImportIcon, Information, Information as InformationIcon, Input, Input as InputIcon, Keys, Keys as KeysIcon, LUCIDE_ICONS, Label, Label as LabelIcon, Lampbulb, Lampbulb as LampbulbIcon, LeftOpen, LeftOpen as LeftOpenIcon, LeftPackup, LeftPackup as LeftPackupIcon, LevelChildren, LevelChildren as LevelChildrenIcon, LevelParent, LevelParent as LevelParentIcon, LevelSame, LevelSame as LevelSameIcon, Like, Like as LikeIcon, Loading, Loading as LoadingIcon, Lock, Lock as LockIcon, LogoDingding, LogoDingding as LogoDingdingIcon, LogoFeishu, LogoFeishu as LogoFeishuIcon, LogoKK, LogoKK as LogoKKIcon, LogoQQ, LogoQQ as LogoQQIcon, LogoWechat, LogoWechat as LogoWechatIcon, Logout, Logout as LogoutIcon, LucideAngularComponent, LucideAngularModule, AnnotateCc as LucideAnnotateCc, AnnotateSign as LucideAnnotateSign, ArrowDoubleLeft as LucideArrowDoubleLeft, ArrowDoubleRight as LucideArrowDoubleRight, ArrowDown as LucideArrowDown, ArrowLeft as LucideArrowLeft, ArrowRight as LucideArrowRight, ArrowUp as LucideArrowUp, BatchAdd as LucideBatchAdd, BatchDelete as LucideBatchDelete, BookMark as LucideBookMark, BtnAdd as LucideBtnAdd, BtnChange as LucideBtnChange, BtnDelete as LucideBtnDelete, BtnFold as LucideBtnFold, BtnMore as LucideBtnMore, BtnPlay as LucideBtnPlay, BtnUnfold as LucideBtnUnfold, Bug as LucideBug, Calendar as LucideCalendar, Change as LucideChange, ChartHistogram as LucideChartHistogram, Checkin as LucideCheckin, Cloud as LucideCloud, Collection as LucideCollection, Confirm as LucideConfirm, Copy as LucideCopy, Cross as LucideCross, Data as LucideData, DataExport as LucideDataExport, DataImport as LucideDataImport, DataPermission as LucideDataPermission, DataSwitch as LucideDataSwitch, DateTime as LucideDateTime, Delete as LucideDelete, Dialogue as LucideDialogue, Diamond as LucideDiamond, DirectionRightUp as LucideDirectionRightUp, Download as LucideDownload, Earth as LucideEarth, Earthset as LucideEarthset, Edit as LucideEdit, Emoticon as LucideEmoticon, EmoticonDiscouraged as LucideEmoticonDiscouraged, Entrust as LucideEntrust, Erase as LucideErase, ExchangeUd as LucideExchangeUd, ExchangeUdinvertedOrder as LucideExchangeUdinvertedOrder, ExchangeUdorder as LucideExchangeUdorder, Exclamatory as LucideExclamatory, ExclamatoryTriangle as LucideExclamatoryTriangle, Experiment as LucideExperiment, Extport as LucideExtport, File as LucideFile, FileAdd as LucideFileAdd, FilePending as LucideFilePending, FileProcessed as LucideFileProcessed, Fire as LucideFire, FixedPosition as LucideFixedPosition, Folder as LucideFolder, FolderOpen as LucideFolderOpen, FullScreen as LucideFullScreen, FullScreenExit as LucideFullScreenExit, Funnel as LucideFunnel, HalfScreen as LucideHalfScreen, HalfScreenExit as LucideHalfScreenExit, Heart as LucideHeart, Hide as LucideHide, HidePassowrd as LucideHidePassowrd, HomePage as LucideHomePage, LucideIconConfig, LucideIconProvider, Import as LucideImport, Information as LucideInformation, Input as LucideInput, Keys as LucideKeys, Label as LucideLabel, Lampbulb as LucideLampbulb, LeftOpen as LucideLeftOpen, LeftPackup as LucideLeftPackup, LevelChildren as LucideLevelChildren, LevelParent as LucideLevelParent, LevelSame as LucideLevelSame, Like as LucideLike, Loading as LucideLoading, Lock as LucideLock, LogoDingding as LucideLogoDingding, LogoFeishu as LucideLogoFeishu, LogoKK as LucideLogoKK, LogoQQ as LucideLogoQQ, LogoWechat as LucideLogoWechat, Logout as LucideLogout, MeetingRoom as LucideMeetingRoom, MenuList as LucideMenuList, MenuListSelect as LucideMenuListSelect, Message as LucideMessage, MessageAdd as LucideMessageAdd, MoreHor as LucideMoreHor, MoreVer as LucideMoreVer, None as LucideNone, Output as LucideOutput, Page as LucidePage, PageCode as LucidePageCode, Palette as LucidePalette, ParameterSetting as LucideParameterSetting, Paste as LucidePaste, Pause as LucidePause, Pc as LucidePc, Picture as LucidePicture, Place as LucidePlace, Play as LucidePlay, Pound as LucidePound, Process as LucideProcess, Question as LucideQuestion, Quote as LucideQuote, QuoteSmall as LucideQuoteSmall, Refresh as LucideRefresh, Release as LucideRelease, Restoredefault as LucideRestoredefault, Ruler as LucideRuler, Save as LucideSave, Seal as LucideSeal, Search as LucideSearch, Setting as LucideSetting, Short as LucideShort, Shutdown as LucideShutdown, SignCross as LucideSignCross, SignEqual as LucideSignEqual, SignExclamatory as LucideSignExclamatory, SignMinus as LucideSignMinus, SignPlus as LucideSignPlus, SignPound as LucideSignPound, SignTick as LucideSignTick, Signin as LucideSignin, Sort as LucideSort, SortDrag as LucideSortDrag, SortFilterDown as LucideSortFilterDown, SortFilterUp as LucideSortFilterUp, SortInvertedOrder as LucideSortInvertedOrder, SortOrder as LucideSortOrder, Stop as LucideStop, StringTypeBigDeciaml as LucideStringTypeBigDeciaml, StringTypeBlob as LucideStringTypeBlob, StringTypeDouble as LucideStringTypeDouble, StringTypeFloat as LucideStringTypeFloat, StringTypeLong as LucideStringTypeLong, SuccessfulTranslation as LucideSuccessfulTranslation, Tick as LucideTick, TickUnselected as LucideTickUnselected, Time as LucideTime, Timing as LucideTiming, Tool as LucideTool, TowardsDown as LucideTowardsDown, TowardsLeft as LucideTowardsLeft, TowardsRight as LucideTowardsRight, TowardsUp as LucideTowardsUp, Trajectory as LucideTrajectory, Translation as LucideTranslation, TranslationOk as LucideTranslationOk, Unlike as LucideUnlike, Unlock as LucideUnlock, Upload as LucideUpload, Use as LucideUse, User as LucideUser, UserCCList as LucideUserCCList, UserExecutor as LucideUserExecutor, UserGroup as LucideUserGroup, View as LucideView, MeetingRoom, MeetingRoom as MeetingRoomIcon, MenuList, MenuList as MenuListIcon, MenuListSelect, MenuListSelect as MenuListSelectIcon, Message, MessageAdd, MessageAdd as MessageAddIcon, Message as MessageIcon, MoreHor, MoreHor as MoreHorIcon, MoreVer, MoreVer as MoreVerIcon, None, None as NoneIcon, Output, Output as OutputIcon, Page, PageCode, PageCode as PageCodeIcon, Page as PageIcon, Palette, Palette as PaletteIcon, ParameterSetting, ParameterSetting as ParameterSettingIcon, Paste, Paste as PasteIcon, Pause, Pause as PauseIcon, Pc, Pc as PcIcon, Picture, Picture as PictureIcon, Place, Place as PlaceIcon, Play, Play as PlayIcon, Pound, Pound as PoundIcon, Process, Process as ProcessIcon, Question, Question as QuestionIcon, Quote, Quote as QuoteIcon, QuoteSmall, QuoteSmall as QuoteSmallIcon, Refresh, Refresh as RefreshIcon, Release, Release as ReleaseIcon, Restoredefault, Restoredefault as RestoredefaultIcon, Ruler, Ruler as RulerIcon, Save, Save as SaveIcon, Seal, Seal as SealIcon, Search, Search as SearchIcon, Setting, Setting as SettingIcon, Short, Short as ShortIcon, Shutdown, Shutdown as ShutdownIcon, SignCross, SignCross as SignCrossIcon, SignEqual, SignEqual as SignEqualIcon, SignExclamatory, SignExclamatory as SignExclamatoryIcon, SignMinus, SignMinus as SignMinusIcon, SignPlus, SignPlus as SignPlusIcon, SignPound, SignPound as SignPoundIcon, SignTick, SignTick as SignTickIcon, Signin, Signin as SigninIcon, Sort, SortDrag, SortDrag as SortDragIcon, SortFilterDown, SortFilterDown as SortFilterDownIcon, SortFilterUp, SortFilterUp as SortFilterUpIcon, Sort as SortIcon, SortInvertedOrder, SortInvertedOrder as SortInvertedOrderIcon, SortOrder, SortOrder as SortOrderIcon, Stop, Stop as StopIcon, StringTypeBigDeciaml, StringTypeBigDeciaml as StringTypeBigDeciamlIcon, StringTypeBlob, StringTypeBlob as StringTypeBlobIcon, StringTypeDouble, StringTypeDouble as StringTypeDoubleIcon, StringTypeFloat, StringTypeFloat as StringTypeFloatIcon, StringTypeLong, StringTypeLong as StringTypeLongIcon, SuccessfulTranslation, SuccessfulTranslation as SuccessfulTranslationIcon, Tick, Tick as TickIcon, TickUnselected, TickUnselected as TickUnselectedIcon, Time, Time as TimeIcon, Timing, Timing as TimingIcon, Tool, Tool as ToolIcon, TowardsDown, TowardsDown as TowardsDownIcon, TowardsLeft, TowardsLeft as TowardsLeftIcon, TowardsRight, TowardsRight as TowardsRightIcon, TowardsUp, TowardsUp as TowardsUpIcon, Trajectory, Trajectory as TrajectoryIcon, Translation, Translation as TranslationIcon, TranslationOk, TranslationOk as TranslationOkIcon, Unlike, Unlike as UnlikeIcon, Unlock, Unlock as UnlockIcon, Upload, Upload as UploadIcon, Use, Use as UseIcon, User, UserCCList, UserCCList as UserCCListIcon, UserExecutor, UserExecutor as UserExecutorIcon, UserGroup, UserGroup as UserGroupIcon, User as UserIcon, View, View as ViewIcon, formatFixed, luiIconIcons as icons };
//# sourceMappingURL=lui-icon-angular-src-icons.mjs.map
