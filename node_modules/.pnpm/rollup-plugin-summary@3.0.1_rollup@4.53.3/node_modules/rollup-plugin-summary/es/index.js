    ...
    return {
        ...
        generateBundle: function (options, bundle) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (options.dir)
                    identifierList.push(options.dir);
                if (options.file)
                    identifierList.push(options.file);
                if (options.format)
                    identifierList.push(options.format);
        ...
        closeBundle: function () {
            return __awaiter(this, void 0, void 0, function* () {
                info.forEach((output, dir) => {
                    ...
                    if (showMinifiedSize)
                        headers.push("Minified");
                    if (showGzippedSize)
                        headers.push("Gzipped");
                    if (showBrotliSize)
                        headers.push("Brotli");
                    ...
                    const printable = output.map(file => {
                        ...
                        if (showMinifiedSize)
                            output.push(file.minified.coloredValue);
                        if (showGzippedSize)
                            output.push(file.gzipped.coloredValue);
                        if (showBrotliSize)
                            output.push(file.brotli.coloredValue);
                        return output;
                    });
                    ...
                    const separator = generateSeparator([
                        ...
                        ...output.map(file => {
                            ...
                            if (showMinifiedSize)
                                output.push(file.minified.displayValue);
                            if (showGzippedSize)
                                output.push(file.gzipped.displayValue);
                            if (showBrotliSize)
                                output.push(file.brotli.displayValue);
                            return output;
                        }),
                    ]);
